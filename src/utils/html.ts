...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://res.cloudinary.com/dedlyz6hn/image/upload/v1729862794/Tecno-White-Logo_yqs4v1.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 14%;max-width: 88.2px;" width="88.2" class="v-src-width v-src-max-width"/>
...
const sucessfullyRegisteredHTML = ({
  eventName,
  leaderName,
  moduleName,
}: {
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="color: #ececec; line-height: 170%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 170%;">
        <span style="font-family: Raleway, sans-serif; font-size: 16px; line-height: 27.2px;">
          <span style="color: #4edfff; font-size: 16px; line-height: 27.2px;">
            You have successfully registered for 
            <span style="color: #4edfff; font-size: 16px; line-height: 27.2px;">${eventName}</span> 
            from <span style="color: #4edfff; font-size: 16px; line-height: 27.2px;">${moduleName}
          </span> 
          module.
        </span>
      </p>
...
export {
  createRegisterInvitationHTML,
  createRegisterCreationHTML,
  sucessfullyRegisteredHTML,
};
